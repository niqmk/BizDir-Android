...
import id.bizdir.ui.adapter.ForumStatePagerAdapter;
...
public class ForumMainFragment extends Fragment {
    ...
    private ForumStatePagerAdapter mPagerAdapter;

    /**
     * Returns a new instance of this fragment for the given section
     * number.
     */
    public ForumMainFragment newInstance() {
        ForumMainFragment fragment = new ForumMainFragment();
        return fragment;
    }

    public ForumMainFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPagerAdapter = new ForumStatePagerAdapter(getFragmentManager());
