...
public class ForumThreadAdapter extends ArrayAdapter<ForumThread> {
    ...
    public ForumThreadAdapter(Activity context, int layoutId, List<ForumThread> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ForumThread opportunity = list.get(position);
        holder.title.setText(opportunity.getTitle().trim());
        holder.textReplyCount.setText(Integer.toString(opportunity.getReplyCount()));
        holder.textViewCount.setText(Integer.toString(opportunity.getViewCount()));
        holder.textLatestDate.setText(Helpers.DateToStringPublishDate(opportunity.getCreateDate()));
